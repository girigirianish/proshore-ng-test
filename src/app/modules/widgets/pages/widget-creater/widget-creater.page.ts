...
import { WidgetCreaterService, ModalService } from '../../services';
...
export class WidgetCreaterPage implements AfterViewInit {
  ...
  constructor(private readonly widgetCreaterService: WidgetCreaterService, private readonly modalService: ModalService) {}
  ...
  public creatWidget(widget?: WIDGET_TO_RENDER): void {
    this.modalService.open(WidgetFirstComponent);
